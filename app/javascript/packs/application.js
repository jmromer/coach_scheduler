...
if (rootNode) {
  ReactDOM.render(<BookingApp />, rootNode)
}

const appointmentListNode = document.getElementById('js-appointments-list')
if (appointmentListNode) {
  ReactDOM.render(<AppointmentsList />, appointmentListNode)
}
